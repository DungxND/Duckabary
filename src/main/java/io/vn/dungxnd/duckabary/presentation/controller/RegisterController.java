...
public class RegisterController {
    ...
    @FXML private Label erMessage;

    @FXML private SVGPath eyeCfPass;

    @FXML private SVGPath eyeHiddenCfPass;

    @FXML private SVGPath eyeHideen;

    @FXML private SVGPath eyePass;

    @FXML private PasswordField hiddenCfPass;

    @FXML private PasswordField hiddenPass;

    @FXML private AnchorPane mainPane;

    @FXML private TextField textCfPass;
